...
export const IconSun = (props) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        className="dark:text-white dark:hover:text-secondary-500"
...
export const IconMenor = (props) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
      data-icon="angle-left"
      className="prefix__svg-inline--fa prefix__fa-angle-left prefix__fa-w-8"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 256 512"
      {...props}
    >
...
export const IconMayor = (props) => {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
      data-icon="angle-right"
      className="prefix__svg-inline--fa prefix__fa-angle-right prefix__fa-w-8"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 256 512"
      {...props}
    >
