      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div className="">
          <div className="w-full flex justify-between items-center bg-black dark:bg-primary-800 py-2 px-4">
            <div className="text-white font-bold">Iphone</div>
        ...
        <div className="">
          <div className="w-full flex justify-between items-center bg-black py-2 px-4">
            <div className="text-white font-bold">Android</div>
            <div className="bg-secondary-400 text-center text-white w-15 text-xs font-bold p-1">
              <h5>Ver todo</h5>
            </div>
          </div>
          <div className="bg-white p-4">
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="flex gap-3">
                <div className="relative w-36 h-16">
                  <Image src="/images/aplicacion3.jpeg" layout="fill" alt="" />
                </div>
                <div className="flex flex-col gap-1">
                  <div className="font-bold text-base dark:text-white">TikTok estilo iPhone en Android + Emojis iOs15 </div>
                  <div className="text-primary-200 text-sm text-left">
